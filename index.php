...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="index1.php">Venadillo</a>
            <!-- Sidebar Toggle-->
            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    <a  id="navbarDropdown" href="login.html"  ><i class="fas fa-user fa-fw"></i></a>
...
<div class="container">
	...
	<div class="row">
		<div class="col">
			<div class="card mt-4">
				<div class="card-body">
					<a href="#" class="btn btn-primary"id="modal-open">Agregar Usuario</a>	
					<hr>
